...
EMOJIS = {
    ...
    "shield": ("🛡️", "5316827280863934685"), # Placeholder ID
    "fire": ("🔥", "5447644880824181073"),   # Placeholder ID
    "apple": ("🍎", "5226656353744862682"),  # Placeholder ID
    "name_icon": ("🆔", "5316992572680320646"), # Placeholder ID
    "mobile": ("📱", "5316571734604790521"),  # Placeholder ID
    "pencil": ("✏️", "5447644880824181073"),  # Placeholder ID
    "fail": ("🚫", "4958526153955476488"),    # Placeholder ID
}
...
def get_main_menu(user_id):
    ...
    # Using the style and icon_custom_emoji_id as requested
    buttons = [
